...
VALUES (0, 'test00001', 'test user', 'test@example.com', 'password', 'USER', NULL, true, false);
INSERT INTO creator (id, name, surname, birth_date, bio, creator_type, avatar, payment_email)
VALUES (0, 'Creator', 'Test', to_date('1985-05-16', 'YYYY-MM-DD'), 'Biography', 'ARTIST',
